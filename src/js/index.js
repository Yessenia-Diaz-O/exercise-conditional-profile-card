...
function render(variables = {}) {
  ...
  if (variables.name == null) variables.name = " yessenia ";
  if (variables.lastname == null) variables.lastname = " diaz ";
  if (variables.role == null) variables.role = " estudiante ";
  if (variables.city == null) variables.city = " SCL ";
